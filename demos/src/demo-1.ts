...
import { SimpleUser, SimpleUserDelegate, SimpleUserOptions } from "sip.js/lib/platform/web/index.js";
...
const webSocketServer = "ws://127.0.0.1:8443";
serverSpan.innerHTML = webSocketServer;

// Destination URI
const target = "sip:5001@192.168.1.33";
//const target = "sip:echo@sipjs.onsip.com";
targetSpan.innerHTML = target;

// Name for demo user
const displayName = "5003";

// AOR for demo user
const aor = "sip:5003@192.168.1.33";
